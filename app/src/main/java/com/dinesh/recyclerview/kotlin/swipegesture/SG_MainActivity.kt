...
class SG_MainActivity : AppCompatActivity() {
//    https://medium.com/getpowerplay/understanding-swipe-and-drag-gestures-in-recyclerview-cb3136beff20
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val deleteIcon = resources.getDrawable(R.drawable.ic_baseline_drag_handle_24, null)
        val archiveIcon = resources.getDrawable(R.drawable.ic_baseline_search_24, null)
